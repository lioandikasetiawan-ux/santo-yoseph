...
@section('title', 'Galeri Foto - Paroki Santo Yoseph Sidareja')

@section('content')
<div class="bg-blue-900 text-white py-12 mb-8">
    <div class="max-w-7xl mx-auto px-4 text-center">
        <h1 class="text-3xl font-extrabold mb-2">Galeri Foto Kegiatan</h1>
        <p class="text-blue-100 text-sm">Dokumentasi momen dan kegiatan umat paroki.</p>
    </div>
</div>
...
<div class="max-w-7xl mx-auto px-4 py-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition flex flex-col justify-between">
            <div>
                <!-- Perbaikan pemanggilan gambar menggunakan Storage::url dan kolom image_path -->
                ...
                <div class="p-4">
                    ...
                    @if(!empty($item->category))
                        <span class="inline-block bg-blue-50 text-blue-700 text-[10px] font-semibold px-2 py-0.5 rounded">
                            {{ $item->category }}
                        </span>
                    @endif
                </div>
